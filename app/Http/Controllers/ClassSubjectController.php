...
class ClassSubjectController extends Controller
{
    public function list(Request $request)
    {
        ...
        $data['header_title'] = 'List Pemilihan Kelas';
    ...
    public function insert(Request $request)
    {
        ...
        {
            return redirect()->with('error', "Due to some error pls try again");
        }
    }
    ...
    public function edit($id)
    {
        ...
        if(!empty($getRecord))
        {
            ...
            $data['getClass'] = ClassModel::getClass();
            $data['getSubject'] = SubjectModel::getSubject();
            $data['header_title'] = 'Edit Pemilihan Kelas';
    ...
    public function update_single($id, Request $request)
    {
        if (!empty($request->subject_id)) {
            ...
            if (!empty($getAlreadyFirst)) {
                ...
                $save = ClassSubjectModel::getSingle($id);
                $save->class_id = $request->class_id;
                $save->subject_id = $request->subject_id; // Menggunakan $request->subject_id sebagai nilai subject_id
                $save->status = $request->status;
                $save->save();
