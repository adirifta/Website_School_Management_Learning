                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" value="{{ old('nomor_pendaftaran', $getRecord->nomor_pendaftaran) }}" name="nomor_pendaftaran" required placeholder="Nomor Pendaftaran">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" value="{{ old('agama', $getRecord->agama) }}" name="agama" placeholder="Agama">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="golongan_darah" value="{{ old('golongan_darah', $getRecord->golongan_darah) }}" placeholder="Golongan Darah">
                            <div style="color:red">{{ $errors->first('golongan_darah') }}</div>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Tinggi <span style="color: red;"></span></label>
                            <input type="text" class="form-control" name="tinggi" value="{{ old('tinggi', $getRecord->tinggi) }}" placeholder="Tinggi">
                            <div style="color:red">{{ $errors->first('tinggi') }}</div>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Berat Badan <span style="color: red;"></span></label>
                            <input type="text" class="form-control" name="berat" value="{{ old('berat', $getRecord->berat) }}" placeholder="Berat Badan">
