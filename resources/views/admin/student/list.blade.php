      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
                <a href="{{ url('admin/student/add') }}" class="btn btn-primary">Add New Siswa</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                      ...
                      <div class="card-body">
                          <div class="row">
                              ...
                              <div class="form-group col-md-2">
                                  ...
                                  <input type="text" class="form-control" name="nomor_pendaftaran" value="{{ Request::get('nomor_pendaftaran') }}" placeholder="Nomer Pendaftaran">
                              </div>
                              <div class="form-group col-md-2">
                              ...
                              <div class="form-group col-md-2">
                                  <label>Agama</label>
                                  <input type="text" class="form-control" name="agama" value="{{ Request::get('agama') }}" placeholder="Agama">
                              </div>
                              <div class="form-group col-md-2">
                              ...
                              <div class="form-group col-md-2">
                                  ...
                                  <input type="text" class="form-control" name="golongan_darah" value="{{ Request::get('golongan_darah') }}" placeholder="Golongan Darah">
                              </div>
                              <div class="form-group col-md-2">
                                  <label>Status</label>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $value->orangtua_name }} {{ $value->orangtua_last_name }}</td>
                        <td>{{ $value->email }}</td>
                        <td>{{ $value->nomor_pendaftaran }}</td>
