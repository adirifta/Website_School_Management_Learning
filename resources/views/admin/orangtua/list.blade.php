      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
                <a href="{{ url('admin/orangtua/add') }}" class="btn btn-primary">Add New Orang Tua</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                  <h3 class="card-title">Search Orang Tua</h3>
              </div>
                      ...
                      <div class="card-body">
                          <div class="row">
                              ...
                              <div class="form-group col-md-2">
                                  ...
                                  <input type="text" class="form-control" name="pekerjaan" value="{{ Request::get('pekerjaan') }}" placeholder="Pekerjaan">
                              </div>
                              <div class="form-group col-md-2">
                                  <label>Alamat</label>
                                  <input type="text" class="form-control" name="alamat" value="{{ Request::get('alamat') }}" placeholder="Alamat">
                              </div>
                              <div class="form-group col-md-2">
                              ...
                              <div class="form-group col-md-3">
                                  ...
                                  <a href="{{ url('admin/orangtua/list') }}" class="btn btn-success" style="margin-top: 32px;">Reset</a>
                          </div>
                      </div>
                  </form>
              </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td style="min-width: 264px;">
                            <a href="{{ url('admin/orangtua/edit/'.$value->id)}}" class="btn btn-primary" style="">Edit</a>
                            <a href="{{ url('admin/orangtua/delete/'.$value->id)}}" class="btn btn-danger">Delete</a>
                            <a href="{{ url('admin/orangtua/my-student/'.$value->id)}}" class="btn btn-primary">My Student</a>
                        </td>
                    </tr>
                    @endforeach
                  </tbody>
