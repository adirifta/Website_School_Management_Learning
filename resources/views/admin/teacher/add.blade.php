                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" value="{{ old('status_pernikahan') }}" name="status_pernikahan" placeholder="Status Pernikahan">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea class="form-control" name="alamat_asli" value="{{ old('alamat_asli') }}"></textarea>
                            <div style="color:red">{{ $errors->first('alamat_asli') }}</div>
                        </div><div class="form-group col-md-6">
                            <label>Kualifikasi <span style="color: red;"></span></label>
                            <textarea class="form-control" name="kualifikasi" value="{{ old('kualifikasi') }}"></textarea>
                            <div style="color:red">{{ $errors->first('kualifikasi') }}</div>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Pengalaman Kerja <span style="color: red;"></span></label>
                            <textarea class="form-control" name="pengalaman_kerja" value="{{ old('pengalaman_kerja') }}"></textarea>
