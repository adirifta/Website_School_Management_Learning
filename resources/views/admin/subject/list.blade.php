      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
                <a href="{{ url('admin/subject/add') }}" class="btn btn-primary">Add New Materi</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                            ...
                            <div class="form-group col-md-3">
                                <label>Pembelajaran</label>
                                  <select class="form-control" name="type">
                                      ...
                                      <option {{ (Request::get('type') == 'Teori') ? 'selected' : '' }} value="Teori">Teori</option>
                                      <option {{ (Request::get('type') == 'Praktik') ? 'selected' : '' }} value="Praktik">Praktik</option>
                                  </select>
                            </div>
                            <div class="form-group col-md-3">
                                <label>Tanggal</label>
